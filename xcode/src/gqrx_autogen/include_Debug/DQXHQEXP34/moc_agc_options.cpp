...
#include <memory>
#include "../../../../../src/qtgui/agc_options.h"
...
void CAgcOptions::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CAgcOptions *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CAgcOptions::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CAgcOptions::gainChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (CAgcOptions::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CAgcOptions::thresholdChanged)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (CAgcOptions::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CAgcOptions::slopeChanged)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (CAgcOptions::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CAgcOptions::decayChanged)) {
                *result = 3;
                return;
            }
        }
        {
            using _t = void (CAgcOptions::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CAgcOptions::hangChanged)) {
                *result = 4;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CAgcOptions::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_CAgcOptions.data,
    qt_meta_data_CAgcOptions,
    qt_static_metacall,
    nullptr,
    nullptr
} };
